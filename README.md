...
2. [Generate a new public and private SSH key](https://docs.github.com/en/github/authenticating-to-github/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent) by running:
   ...
   ```zsh
   curl https://raw.githubusercontent.com/dannynhois/osxSetup/main/ssh.sh | sh -s "dannynhois@gmail.com"
   ```

3. Clone this repo to `~/.dotfiles` with:

    ```zsh
    git clone git@github.com:dannynhois/osxSetup.git ~/.dotfiles
    ```
...
Some steps can't be automated so we need to peform these manually after the scripts have completed.
1. Install Alfred3 https://cachefly.alfredapp.com/Alfred_3.8.6_972.dmg . Enter key. Update HotKey for Siri and Alfred3. Sync preferences
2. Register Keyboard Maestro
